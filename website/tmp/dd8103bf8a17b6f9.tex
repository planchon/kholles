...
\end{itemize}\subsection{Limites de validité d'une proposition}Déterminer les réels $x$ pour lesquels l'assertion suivante est vraie :
$$\forall y\in[0,1],\ x\geq y\implies x\geq 2y.$$\newpage\section{Indicators}\section{Vraies ou fausses}pas d'indication :(\section{Limites de validité d'une proposition}Séparer en 4cas : $x\geq 2$, $x\in]0,2[$ et $x= 0$ et $x&lt;0$.\newpage\section{Corriges}\section{Vraies ou fausses}\begin{itemize}
